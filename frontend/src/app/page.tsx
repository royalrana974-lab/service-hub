    ...
    <main className="w-full">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 space-y-4 shadow-2xl border border-gray-100">
              {[
                ...
                <div
                  key={index}
                  className="group border-2 border-gray-100 rounded-xl p-5 flex items-center gap-4 hover:border-gray-300 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
                >
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${item.color} rounded-lg flex items-center justify-center text-white text-xl font-bold shadow-md group-hover:scale-110 transition-transform`}
                  >
                    {item.icon}
                  </div>
      ...
      <section className="bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 text-center gap-8 relative z-10">
          <div className="transform hover:scale-110 transition-transform duration-300">
            <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">
              50K+
            </h2>
          ...
          <div className="transform hover:scale-110 transition-transform duration-300">
            <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">
              100+
            </h2>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 bg-white">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">Browse Services</h2>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="group bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-gray-900 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              >
                <div
                  className={`h-48 bg-gradient-to-br ${s.color} flex items-center justify-center text-6xl group-hover:scale-110 transition-transform duration-300 relative overflow-hidden`}
                >
      ...
      <section className="text-center py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-lg mb-12">
            Get your services done in three simple steps
          </p>
            ...
            {[
              {
                ...
                desc: 'Browse through our large selection of professional services.',
                icon: '🔍',
              ...
              },
              {
                step: '02',
                title: 'Book & Schedule',
                desc: 'Select your preferred date and time for service completion.',
                icon: '📅',
              ...
              },
              {
                step: '03',
                title: 'Get it Done',
                desc: 'Our verified professionals arrive and complete the service.',
                icon: '✅',
              ...
              <div key={i} className="group relative">
                <div className="p-8 border-2 border-gray-200 rounded-2xl hover:border-gray-900 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 bg-white">
                  <div
                    className={`w-20 h-20 mx-auto bg-gradient-to-br ${item.color} rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                  >
                    {item.icon}
                  </div>
